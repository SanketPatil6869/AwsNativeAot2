...
namespace AWSServerlessNativeAOT;
...
public class Functions
{
    ...
    private static async Task Main()
    {
        ...
        Func<APIGatewayHttpApiV2ProxyRequest, ILambdaContext, APIGatewayHttpApiV2ProxyResponse> handler = configuredFunctionHandler switch
        {
    ...
    /// <returns></returns>
    public APIGatewayHttpApiV2ProxyResponse GetFunctionHandler(APIGatewayHttpApiV2ProxyRequest request, ILambdaContext context)
    {
        context.Logger.LogInformation("Get Request\n");
      
        var queryString = request.QueryStringParameters != null
